    ...
    <?php if(!isset($_SESSION['email'])):?>
        <div class="containeer">
            <form action="" method="POST">
                <input type="text" placeholder='First Name' class='text' id='firstname' name="first_name" required><br>
                <input type="text" placeholder='Last Name' class='text' id='lastname' name="last_name" required><br>
                ...
                <input type="password" placeholder='Confirm password' class='password' name="confirm_password"><br>
                <input type="submit" name="register-submit" placeholder="Register now" value="Register" class='btn-login' id='do-login'>
            </form>
        </div>
        <?php else:
            redirect("index.php");
